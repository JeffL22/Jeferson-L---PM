...
informacionn sobre lluvias, genera informacion estadistica. */
...
void Lectuta (float A[][MES][AÑO], int C, int P)
...
de precipitacion pluvial en los ultimos 10 anos. Escribe el registro
correspondiente. */
{
    int I, K, J, EMAY = -1;
    float ELLU = -1.0, SUM;
...
de lluvias en el ultimo ano. Escribe ademas el registro correspondiente. */
{
    ...
    printf("\n\nProvincia con menos registro anual de lluvias en el ultimo ano: %d", EMEN+1);
