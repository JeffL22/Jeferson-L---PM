...
/* Funciones para el manejo de caractreres de la biblioteca stdio.h */
...
void main(void)
{
    ...
    asigna el simbolo $. */
    printf("\nIngrese un caracter: ");
    p1=getchar();   /* Se utiliza la funcion getchat para leer un caracter. */
    putchar(p1);    /* Se utiliza la funcion putchat para escribir un caracter. */
    printf("\n");
    fflush(stdin);
    ...
    cadena de caracteres se toma a ese return como el nuevo dato ingreso. */
    ...
    fflush(stdin);
    /* Se puede utilizar scanf con el formato variable %c para leer un caracter. */
    printf("%c", p2);
